...
class Pastel::Delegator
  ...
  def alias_color(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/pastel#lib/pastel/delegator.rb:16
  def colored?(*_arg0, **_arg1, &_arg2); end

  # pkg:gem/pastel#lib/pastel/delegator.rb:16
  def decorate(*_arg0, **_arg1, &_arg2); end
