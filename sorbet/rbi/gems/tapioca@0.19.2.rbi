...
class T::Private::Methods::DeclBuilder
  # pkg:gem/tapioca#lib/tapioca/sorbet_ext/void_patch.rb:18
  def finalize!; end

  # pkg:gem/tapioca#lib/tapioca/sorbet_ext/void_patch.rb:12
  def void; end
end

# pkg:gem/tapioca#lib/tapioca/sorbet_ext/void_patch.rb:11
