  ...
  context 'with github.com' do
    ...
    context 'with assignee filtering' do
      it 'should list the issues' do
        allow(git_client).to receive(:remote).with(name: 'origin').and_return('git@github.com:donaldduck/testrepo_gh')
    ...
    it 'should list the upstream issues' do
      allow(git_client).to receive(:remote).with(name: 'origin').and_return('git@github.com:donaldduck/testrepo_2f')
